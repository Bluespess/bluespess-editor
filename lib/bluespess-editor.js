...
const IconStateEditor = require('./icon-state-editor/icon-state-editor.js');
const MapEditor = require('./map-editor/map-editor.js');
const MapEditorStatusView = require('./map-editor/map-editor-status-view.js');
const BSMap = require('./map-editor/map.js');
const ObjectTreeView = require('./map-editor/object-tree-view.js');
const VariantView = require('./map-editor/variant-view.js');
