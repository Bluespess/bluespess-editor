...
export default class BSMap {
	...
	sort_objects() {
		...
		this.objects.sort((a,b) => {return this.map.context.client_env.atom_comparator(a.client_atom, b.client_atom);});
	}
}
...
class Instance {
	...
	set_pos(x, y) {
		...
		if(this.x != null && this.y != null) {
			...
			this.grid_tile.sort((a,b) => {return this.map.context.client_env.atom_comparator(a.client_atom, b.client_atom);});
		}
